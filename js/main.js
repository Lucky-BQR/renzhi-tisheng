...
const articles = [
    {
        id: '2026-07-01-fupan',
        date: '2026-07-01',
        title: '7月1日复盘：半导体冲高回落板块轮动，立昂微+2.89%领涨，兴森科技首日吃面，账户+0.33%',
        desc: '上证+0.44%收4112点，保险养殖化工大涨分流半导体资金。立昂微+2.89%（涨价生效）、京东方A+1.04%（V型反弹）、斯达半导-0.69%（正常回调）、圣晖集成-1.71%（缩量整理）、兴森科技-7.20%（追高吃面）。黄金：伦敦金4025美元低位震荡，半年回撤超28%。账户+0.33%，交易心理大考。',
        tags: ['每日复盘', '市场分析', '半导体', '板块轮动', '立昂微', '兴森科技', '黄金复盘', '交易心理'],
        category: '每日复盘'
    },
    {
        id: '2026-06-30-fupan',
    ...
    {
        id: '2026-07-01-jingjia',
        date: '2026-07-01',
        title: '📖 集合竞价看盘框架：从9:15到9:25的实战拆解（四步法+六种竞价组合+四个案例）',
        desc: '系统化竞价教学：三个关键时间段（可撤单/不可撤单/出开盘价）、委比委差验真方法、六种典型竞价组合快速判断、竞价四步法检查清单。附斯达半导（虚单）/立昂微（压价吸筹）/京东方A（最后砸盘）/圣晖集成（试砸拉回）四个7月1日实战案例。',
        tags: ['投资学习', '集合竞价', '看盘技巧', '委比委差', '实战案例', '入门', '新手友好'],
        category: '投资学习'
    },
    {
        id: '2026-07-01-sell-framework',
        date: '2026-07-01',
        title: '💡 卖出决策框架：为什么「感觉贵了」是最差的卖出理由',
        desc: '散户最致命的决策模式：赚一点就跑，亏了死扛。解剖三种认知偏差（成本锚定/涨了=贵了/舒服=正确），建立四维度卖出框架（基本面/资金面/估值/趋势），复盘利通电子+雅克科技两笔卖飞教训，附高价股趋势更持久的底层逻辑。核心铁律：不因涨了而卖，只因逻辑变了才卖。',
        tags: ['认知笔记', '卖出决策', '交易纪律', '认知偏差', '卖飞教训', '高价股', '交易心理'],
        category: '认知笔记'
    },
    {
